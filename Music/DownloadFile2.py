...
if __name__=="__main__":
    while True:
        link=input("Link1?(Melon Link)")
        link2=input("Link2?(Youtube Link)")
        ...
        subprocess.call('youtube-dl --no-playlist -o "'+"/Music/file"+'.%(ext)s" --extract-audio --audio-format mp3 '+link2)
        lyrics=AlbumInfo[7]
